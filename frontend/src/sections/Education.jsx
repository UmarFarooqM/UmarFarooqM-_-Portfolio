...
//             My academic background, internships, and certifications that shaped my career path.
//           </p>
//         </motion.div>

//         {/* Grid Layout */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12">
//           {/* ===== Left Side: Education + Internships ===== */}
...
//                   transition={{ duration: 0.6, delay: index * 0.1 }}
//                   viewport={{ once: true }}
//                   className="p-5 sm:p-6 bg-white dark:bg-gray-800/60 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300"
//                 >
//                   <div className="flex items-start gap-4">
//                     <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-primary-600 to-secondary-600 rounded-full flex items-center justify-center">
//                       <HiAcademicCap className="w-6 h-6 text-white" />
...
//               transition={{ duration: 0.6 }}
//               viewport={{ once: true }}
//               className="text-2xl font-semibold text-gray-900 dark:text-white flex items-center gap-3 mt-10"
//             >
//               <HiBadgeCheck className="text-secondary-600" />
//               Internships
//             </motion.h3>
...
//                 >
//                   <div className="flex items-start gap-4">
//                     <div className="w-12 h-12 bg-gradient-to-r from-secondary-600 to-accent-600 rounded-full flex items-center justify-center">
//                       <HiBadgeCheck className="w-6 h-6 text-white" />
//                     </div>
//                     <div>
//                       <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">
...
//           {/* ===== Right Side: Achievements + Certificates ===== */}
//           <div className="space-y-10">
//             {/* Achievements */}
//             <motion.h3
//               initial={{ opacity: 0, x: 20 }}
...
//                   transition={{ duration: 0.6, delay: index * 0.1 }}
//                   viewport={{ once: true }}
//                   className="p-4 bg-white dark:bg-gray-800/60 rounded-lg border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300"
//                 >
...
//                   transition={{ duration: 0.6, delay: index * 0.1 }}
//                   viewport={{ once: true }}
//                   className="p-4 bg-white dark:bg-gray-800/60 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 flex items-center gap-3"
//                 >
//                   <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg flex items-center justify-center">
//                     <HiAcademicCap className="w-5 h-5 text-white" />
//                   </div>
